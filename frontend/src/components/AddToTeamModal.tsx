...
import type { TeamSummary, TeamCategory, Prompt } from '@/types';
...
export default function AddToTeamModal({
  ...
  const [step, setStep] = useState<'select-team' | 'select-category' | 'success'>('select-team');
  ...
  const handleSubmit = async () => {
    ...
    try {
      await api.addTeamPrompt(selectedTeam.id, {
        sourceType: 'library',
        sourceId: prompt.id,
        title: prompt.title,
      ...
      setError(err instanceof Error ? err.message : 'Failed to add prompt to team');
    } finally {
      setSubmitting(false);
    }
  };
              ...
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">
                    Select which team to add &quot;{prompt.title}&quot; to
                  </p>
                </div>
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    placeholder="Add any notes for your team about this prompt..."
            ...
            {step === 'success' && selectedTeam && (
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">
                    &quot;{prompt.title}&quot; has been added to{' '}
